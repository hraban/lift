...
(defmethod do-testing :around ((suite measured-test-mixin) result fn)
  (declare (ignore fn))
  (setf (values (total-seconds suite) (total-conses suite))
	(measure #'call-next-method))
  (values result (total-seconds suite) (total-conses suite)))

#|

sample 

(deftestsuite test-the-foo ()
  ()
  :measure t)

(addtest (test-the-foo)
  (ensure 23)
  (sleep 0.5)
  (ensure 1))
